...
struct zzmoove_profile zzmoove_profiles[] = {
	{
...
#endif /* ENABLE_SNAP_THERMAL_SUPPORT */
		1593600,	// scaling_block_freq (all valid system frequencies)
		...
		1593600,	// inputboost_punch_freq (0=disable, range from 0 to freq->max in khz)
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1593600,	// music_max_freq (0=disable, range from 0 to freq->max in khz)
		192000,		// music_min_freq (0=disable, range from 0 to freq->min in khz)
...
#endif /* ENABLE_INPUTBOOSTER */
#ifdef ENABLE_MUSIC_LIMITS
		1593600,	// music_max_freq
		192000,		// music_min_freq
		2,		// music_min_cores
#endif /* ENABLE_MUSIC_LIMITS */
		95,		// smooth_up
#if defined(CONFIG_HAS_EARLYSUSPEND) || defined(CONFIG_POWERSUSPEND) || defined(USE_LCD_NOTIFIER)
