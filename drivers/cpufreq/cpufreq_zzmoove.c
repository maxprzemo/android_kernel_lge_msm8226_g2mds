...
#define DEF_PROFILE_NUMBER				(8)	// ZZ: default profile number (profile = 0 = 'none' = tuneable mode)
...
#define DEF_INPUTBOOST_PUNCH_FREQ			(1593600)	// ff: default frequency to keep cur_freq at or above
...
#define DEF_MUSIC_MAX_FREQ				(1593600)	// ff: default maximum freq to maintain while music is on
#define DEF_MUSIC_MIN_FREQ				(192000)	// ff: default minimum freq to maintain while music is on
#ifdef ENABLE_HOTPLUGGING
